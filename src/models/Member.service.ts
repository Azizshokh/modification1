...
class MemberService {
    ...
    public async login(input: LoginInput): Promise<Member> {
        ...
        else if (member.memberStatus === MemberStatus.BLOCKED) throw new Errors(HttpCode.FORBIDDEN, Message.BLOCKED_USER);
    ...
    public async updateMemberDetail(member: MemberUpdateInput, input: MemberUpdateInput): Promise<Member> {
        const memberId = shapeIntoMongooseObjectId(member._id);
        const result = await this.memberModel
